package net.kdt.pojavlaunch.firefly.contracts;
...
public class OpenDocumentWithExtension extends ActivityResultContract<Object, Uri> {
    ...
    /**
     * Create a new OpenDocumentWithExtension contract for multiple extensions.
     * Uses star-slash-star as MIME type to allow all types, filtering should be done by caller.
     *
