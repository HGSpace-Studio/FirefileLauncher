...
import static net.kdt.pojavlaunch.firefly.MainActivity.touchCharInput;
import static net.kdt.pojavlaunch.firefly.utils.MCOptionUtils.getMcScale;
...
import net.kdt.pojavlaunch.firefly.customcontrols.gamepad.DefaultDataProvider;
import net.kdt.pojavlaunch.firefly.customcontrols.gamepad.Gamepad;
import net.kdt.pojavlaunch.firefly.customcontrols.mouse.AbstractTouchpad;
import net.kdt.pojavlaunch.firefly.customcontrols.mouse.AndroidPointerCapture;
import net.kdt.pojavlaunch.firefly.customcontrols.mouse.InGUIEventProcessor;
import net.kdt.pojavlaunch.firefly.customcontrols.mouse.InGameEventProcessor;
import net.kdt.pojavlaunch.firefly.customcontrols.mouse.TouchEventProcessor;
...
public class MinecraftGLSurface extends View implements GrabListener {
    ...
    private void realStart(Surface surface) {
        ...
        // Use "false" instead of "off" for MC 1.21.5+ compatibility
