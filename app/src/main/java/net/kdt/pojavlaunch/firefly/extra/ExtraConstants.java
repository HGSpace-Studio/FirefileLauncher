package net.kdt.pojavlaunch.firefly.extra;
...
public class ExtraConstants {
    ...
    /* ExtraCore constant: Local authentication to perform */
    public static final String LOCAL_LOGIN_TODO = "local_login_todo";
    /* ExtraCore constant: Add minecraft account procedure, the user has to select between local or other login */
